		...
		properties: [
			...
			// ── Subject operations (6 total) ──
			{
				...
				options: [
					...
					{ name: 'Search by NIPs (Batch)', value: 'searchByNips', description: 'Batch search up to 30 NIP numbers', action: 'Batch search subjects by ni ps' },
					{ name: 'Search by REGON', value: 'searchByRegon', description: 'Search VAT taxpayer by REGON number', action: 'Search subject by REGON' },
					{ name: 'Search by REGONs (Batch)', value: 'searchByRegons', description: 'Batch search up to 30 REGON numbers', action: 'Batch search subjects by rego ns' },
				],
				default: 'searchByNip',
			},
